...
// 두 선수는 1번 음식 1개, 2번 음식 2개, 3번 음식 3개씩을 먹게 되므로 음식의
// 배치는 "1223330333221"이 됩니다. 따라서 1번 음식 1개는 대회에 사용하지 못합니다.
...
const solution = (food) => {
    ...
    for (let i = 0; i < food.length; i++) {
        ...
        left.push(...Array(count).fill(i));
        right.push(...Array(count).fill(i));
    }

    right.reverse();

    let result = [...left, 0, ...right].join("");
    return result;
};
